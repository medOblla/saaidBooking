...
(function($) {
    ...
    function slider() {
        ...
        $('.product-slider-wrapper').each(function() {
            var el = $(this),
                slider = el.find('.product-slider'),
                sliderThumb = el.find('.product-slider-thumb');
            slider.owlCarousel({
                autoPlay: false,
                slideSpeed: 500,
                navigation: true,
                ...
                afterAction : function(el) {
                    ...
                    sliderThumb
                        ...
                        .eq(current)
                        .addClass("synced")
                    if(sliderThumb.data("owlCarousel") !== undefined){"use strict";
                        var center =function (number){

                            var slidethumnailvisible = sliderThumb.data("owlCarousel").owl.visibleItems;
                            var num = number;
                            var found = false;
                            ...
                            if(found == false){
                                if(num>slidethumnailvisible[slidethumnailvisible.length-1]){
                                    sliderThumb.trigger("owl.goTo", num - slidethumnailvisible.length+2)
                                } else {
                                if(num - 1 == -1) {
                                    num = 0;
                                }
                                    sliderThumb.trigger("owl.goTo", num);
                                }
                            } else if(num == slidethumnailvisible[slidethumnailvisible.length-1]) {
                                sliderThumb.trigger("owl.goTo", slidethumnailvisible[1])
                            } else if(num == slidethumnailvisible[0]) {
                                sliderThumb.trigger("owl.goTo", num-1)
                            }
                        }
                        center(current)
                    }
        ...
        $(".accordion").accordion({
            ...
            activate: function(event, ui) {
                $('.tour-map', ui.newPanel).each(function () {
                    ...
                    var latlong = $(this).children().data('latlong');
                    console.log(latlong);
                });
            }
        });
